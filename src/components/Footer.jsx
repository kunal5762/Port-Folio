...
function Footer() {
    return (
        <div className='max-sm:flex max-sm:justify-center max-sm:items-center'>
            <div className='footerFadeDrop max-sm:max-h-[250px] max-sm:max-w-sm max-sm:items-center max-sm:justify-center h-[300px] w-[100%] flex flex-col justify-center items-center '>
